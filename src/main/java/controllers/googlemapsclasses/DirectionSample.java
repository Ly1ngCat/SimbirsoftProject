...
public class DirectionSample extends AbstractSample {
    public static void main(final String[] args) throws IOException, JSONException {
        final String proxy = "https://anonymouse.org/cgi-bin/anon-www.cgi/";
        final String baseUrl = proxy + "https://maps.googleapis.com/maps/api/directions/json";// путь к Geocoding API по
        // HTTP
